...
| 역할 | 이름 | 담당 |
| :---: | :---: | :--- |
| 🧑‍💼 **팀장** | **이민준** | 프로젝트 일정/협업 관리, 기능 통합, 발표 및 산출물 관리 |
| 👨‍💻 팀원 | 김대현 | 금융 서비스 기능 구현 및 백엔드 개발 |
| 👩‍💻 팀원 | 이다은 | 사용자 화면 및 서비스 기능 구현 |
| 👨‍💻 팀원 | 이지민 | 외환/송금 서비스 및 데이터 연동 |
| 👨‍💻 팀원 | 서현우 | AI/검색 기능 및 서버 연동 |
| 👨‍💻 팀원 | 전용준 | 관리자 기능 및 프로젝트 품질 개선 |

> 팀원별 상세 담당 기능은 프로젝트 진행 산출물 기준으로 보완할 수 있습니다.
